...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-2">
                <form action="http://localhost/php/crud/read.php" method="get">
                    <div class="mb-3">
                    ...
                    <a href="http://localhost/php/crud/read.php" class="btn btn-secondary">Clear</a>
                </form>
            </div>
        </div>
    </div>
        ...
        <li class="list-group-item">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-8">
                        <a href="http://localhost/php/crud/show.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-success btn-sm">Show</a>
                        <a href="http://localhost/php/crud/edit.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-info btn-sm">Edit</a>
                        <a href="http://localhost/php/crud/delete.php?id=<?= $box['boxId'] ?>" class="btn btn-outline-danger btn-sm">Delete</a>
                    </div>
                </div>
            </div>
        </li>
